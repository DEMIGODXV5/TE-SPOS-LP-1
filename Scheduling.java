...
public class Scheduling {
    ...
    public static void printResults(Process[] processes, String algorithm) {
        ...
        System.out.printf("%-10s %-12s %-10s %-10s %-16s %-16s %-12s\n",
                "ProcessID", "ArrivalTime", "BurstTime", "Priority",
                "CompletionTime", "TurnaroundTime", "WaitingTime");
        // here %-10s → Print string left-aligned in 10 spaces
        //follows format %-<width><type> where <width> → Minimum number of characters reserved for that value (extra spaces are added if the value is shorter).and <type> → The type of value to print: s-> string , d-> integer and f-> floating point
        ...
        for (Process p : processes) {
            ...
            System.out.printf("%-10d %-12d %-10d %-10d %-16d %-16d %-12d\n",
